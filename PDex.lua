...
function FEATURES()
F = gg.multiChoice({
'🍇 Визуальный подъём\n [ЕСЛИ КИНУТ РЕПОРТ ТОБИ ПИЗДА]',
'🍅(Новое!)Убирание отдачи\n[ИГРА]',
'🍎Антенна(тест)(1)\n[ИГРА]',
'🍎Антенна(тест)(2)\n[ИГРА]',
'🍎Аимбот на голову\n[ИГРА|100м]',
'🌶️ Назад'},nil,'🍊 Функции которые находятся под тестированием!')
if F == nil then else
if F[1] == true then sit() end
if F[2] == true then nor() end
if F[3] == true then norq() end
if F[4] == true then ant() end
if F[5] == true then aimbot() end
if F[6] == true then HOME() end
end
end
...
function sit()
  ...
  gg.toast("Визуальный подъём активирован! ")
end
...
gg.toast('🍎 Антенна тест, без бана!')
end
...
function nor()
  ...
  gg.setVisible(false)
  gg.toast("🍅Убирание отдачи активировано!")
end
